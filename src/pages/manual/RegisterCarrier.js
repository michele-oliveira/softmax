...
import cadastroTransportadora from "../../assets/images/manual/cad_Transp.png";
    ...
    <>
      ...
      <div className="flex flex-col items-center text-center px-4 py-6 lg:px-10 lg:py-12">
        ...
        <div className="flex flex-col items-start w-full max-w-3xl text-left py-6">
          ...
          <p className="text-base pt-2">
            <b>6- Data de cadastro </b> - Informar a data da realização o
            cadastro da transportadora
          </p>
          <p className="text-base pt-2">
            <b>Dados de Endereço/UF/CEP/N°/Bairro/Cidade e Região </b> -
            Preencher todos os campos com as informações corretas
          </p>
          <p className="text-base pt-2">
            <b>Dados de contato </b> - Preencher os campos Telefone, fax,
            contato, e-mail e site da transportadora
          </p>
          <p className="text-base pt-2">
