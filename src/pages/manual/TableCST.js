    ...
    <div className="flex flex-col items-center text-center px-6 py-8 lg:px-12 lg:py-16">
      ...
      <div className="flex flex-col items-center text-center py-8 lg:px-12 lg:py-16">
        ...
        <ul className="max-w-3xl mx-auto list-disc list-inside space-y-4 text-left text-gray-700">
          ...
          <li>
            <strong>300 - Imune</strong> - Classificam-se neste código as
            operações praticadas por optantes pelo Simples Nacional contempladas
            com imunidade do ICMS.
          </li>
          <li>
            <strong>400 - Não tributada pelo Simples Nacional</strong> -
            Classificam-se neste código as operações sujeitas exclusivamente ao
            regime de substituição tributária na condição de substituído
