...
import login from "../assets/images/manual/login.png";
import menu from "../assets/images/manual/Menu.png";
import menuBotoes from "../assets/images/manual/Menu_Botoes_Cadastro.png";
import menuBotoes1 from "../assets/images/manual/Menu_Botoes_Movimento.png";
import menuBotoes2 from "../assets/images/manual/Menu_Botoes_Relatorios.png";
import menuBotoes3 from "../assets/images/manual/Menu_Botoes_Portaria.png";
import menu1 from "../assets/images/manual/Menu_Cadastro.png";
import menu2 from "../assets/images/manual/Menu_Movimento.png";
import menu3 from "../assets/images/manual/Menu_Utilitarios.png";
import menu4 from "../assets/images/manual/Menu_Relatorio.png";
    ...
    <>
      ...
      <div className="flex flex-col items-center text-center px-4 py-6 lg:px-10 lg:py-12">
        ...
        <p className="mx-4 my-6 text-sm sm:text-base lg:max-w-4xl">
          ...
          otimizarem seus processos, melhorarem a produtividade e tomarem
          decisões estratégicas com mais segurança. Conheça a tecnologia que vem
        ...
        <div className="flex flex-col items-start w-full max-w-3xl text-left py-6">
          <p className="text-base pt-2">
            ...
            (Matéria Prima), Outros Materiais, Semi-Acabados,Desenvolvimento
            Pro, Amostras. Cadastros de Agenda e Calendário. Cadastro de
            Operações com mensagens, troca de senha e relogar.
          </p>
        </div>
        ...
        <div className="flex flex-col items-start w-full max-w-3xl text-left py-6">
          ...
          <p className="text-base pt-2">
            <b>9- Desenvolvimento Pro </b> - Realiza o cadastro de
            desenvolvimento pro
          </p>
          <p className="text-base pt-2">
        ...
        <div className="flex flex-col items-start w-full max-w-3xl text-left py-6">
          ...
          <p className="text-base pt-2">
            <b>4- Relatório de Vendas </b> - Gera e imprime o relatório de
            vendas
          </p>
          <p className="text-base pt-2">
          ...
          <p className="text-base pt-2">
            <b>7- Relatório de contas a pagar </b> - Gera e imprime o relatório
            de contas a pagar
          </p>
          <p className="text-base pt-2">
            <b>8- Relatório de Bancário </b> - Gera e imprime o relatório
            Bancário
          </p>
          <p className="text-base pt-2">
